    	...
    	<nav class="ms-4" aria-label="breadcrumb">
  			<ol class="breadcrumb">
  				...
  				if($_SESSION['user_type']=="admin")
  		  		...
  		  		if($_SESSION['add']==1)
    				echo '<li class="breadcrumb-item active" aria-current="page">Adaugă anunț</li>';
    			else
    			{
    				echo '<li class="breadcrumb-item"><a href="Announcement.php?id='.$_SESSION['notification'].'" style="text-decoration: none;">Anunț</a></li>';
    				echo '<li class="breadcrumb-item active" aria-current="page">Editează anunț</li>';
    			}
    			?>
  			</ol>
		</nav>
