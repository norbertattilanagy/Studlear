	...
	<body>
    	...
    	<nav class="ms-4" aria-label="breadcrumb">
  			<ol class="breadcrumb">
    			...
    			<li class="breadcrumb-item active" aria-current="page">Anunț</li>
  			</ol>
		</nav>
    	...
    	<div class="row">
		    ...
		    <div class="col-md-9">
			    	...
			    	$_SESSION['notification']=$notification_id;
					$sql="SELECT * FROM notification WHERE id LIKE $notification_id";
					...
					if($_SESSION['user_type']!="student") { ?>
						<a href="Add_announcement1.php?edit=4&add=0" class="btn btn-primary btn-sm me-2"><i class="bi bi-pencil-square"></i> Editează</a>
						<button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#Delete_notification"><i class="bi bi-trash"></i> Șterge</button>
					<?php } ?>
		  	...
		  	<div class="modal-dialog">
		    	<div class="modal-content">
		      		...
		      		<div class="modal-header">
		        		<h4 class="modal-title">Șterge anunțul</h4>
		        		<button type="button" class="btn-close" data-bs-dismiss="modal" data-bs-target="#Delete_notification"></button>
		      		</div>

		      		<!-- Modal body -->
		      		<div class="modal-body">
		      			<div class="d-flex justify-content-center">
		      				<p><b>Doriti să ștergeți anunțul?</b></p>
		      			</div>
		      			<div class="d-flex justify-content-around">
		      				<div class="d-grid gap-1 col-4">
		      					<a href="Add_announcement1.php?edit=2" class="btn btn-danger">Da</a>
		      				</div>
		      				<div class="d-grid gap-1 col-4">
